...
class _AttrezzatureScreenState extends State<AttrezzatureScreen> {
  ...
  Widget _heroCard() {
    return Card(
      ...
      child: Padding(
        ...
        child: Column(
          children: [
            const Icon(Icons.kitchen_outlined, size: 64, color: Color(0xFFf15a24)),
            ...
            ElevatedButton.icon(
              ...
              label: const Text('Scansiona con Fotocamera', style: TextStyle(fontWeight: FontWeight.bold)),
            ),
          ],
        ),
      ),
  ...
  Widget _manualSection(AttrezzatureProvider provider) {
    return Card(
      elevation: 1,
      shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(16)),
      color: Colors.white,
        ...
        child: Column(
          ...
          children: [
            const Text(
              ...
              style: TextStyle(fontSize: 15, fontWeight: FontWeight.bold, color: Color(0xFF2b303a)),
              textAlign: TextAlign.center,
            ),
          ...
          final Widget content = wide
              ? Row(
                  ...
                  children: [
                    ...
                    Expanded(child: _manualSection(provider)),
                  ],
                )
              : Column(
                  crossAxisAlignment: CrossAxisAlignment.stretch,
